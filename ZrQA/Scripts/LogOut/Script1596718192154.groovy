...
WebUI.click(findTestObject('Object Repository/Page_Insite - QwikCoverage Light/a_Yes Continue_right-sidebar-toggle'))

WebUI.click(findTestObject('Object Repository/Page_Insite - QwikCoverage Light/a_Logout'))
